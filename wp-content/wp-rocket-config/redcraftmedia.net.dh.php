...
$rocket_cookie_hash = 'bf0def21b72ac427ed8e424880af83bf';
$rocket_logged_in_cookie = 'wordpress_logged_in_bf0def21b72ac427ed8e424880af83bf';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_reject_uri = '/dh(/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|/(index.php/)?(.*)wp-json(/.*|$))';
